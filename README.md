...
Результати кожного завершеного раунду та окремі входи в Beauty лов записуються в таблиці `catch_game_results` і `catch_game_sessions`. Застосуйте обидві міграції за порядком:
