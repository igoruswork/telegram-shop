...
У `thumbnail_url` записується оптимізований `render/image` URL: ширина зменшується приблизно до 70% від оригіналу, але не нижче `560px`, якість за замовчуванням `78`.
Фото, завантажені через UI адмінки, перед upload стискаються в браузері до WebP приблизно 70% від ширини/висоти, якщо це дає менший файл.
